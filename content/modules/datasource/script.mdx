...
- [`queryFilter`](/modules/script-context-members#queryfilter)
- [`insertOp`](/modules/script-context-members#insertoperation)
- [`updateOp`](/modules/script-context-members#updateoperation)
- [`deleteOp`](/modules/script-context-members#deleteoperation)
...
- [`resultSet`](/modules/script-context-members#resultset) is used to emit rows for SELECT operations
- [`affectedRows`](/modules/script-context-members#affectedrows) is used to report affected row counts and generated keys
...
[initResult context member](/modules/script-context-members#initresult)
