...
In some cases, finer cache control is necessary, such as enabling or disabling caching on a [per-table basis](/engine/ddl#common-table-directives).
...
as explained in the [Table Directives section](/engine/ddl#common-table-directives).
