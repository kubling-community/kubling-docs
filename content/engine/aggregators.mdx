...
In the case of Kubernetes providers, this behavior might be influenced by the
provider-owned `blankNamespaceStrategy` configuration. The
[Kubernetes provider documentation](https://github.com/kubling-community/kubling-providers/tree/main/providers/kubernetes)
defines the available strategies and their query behavior.
