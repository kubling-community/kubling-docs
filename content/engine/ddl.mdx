...
<Callout type='info'>
  Double underscore in field name has a special meaning in the context of a Script Document Data Source. [See here for more information.](#path-like-access)
</Callout>

## Options

<Callout type='warning'>
  The following options are specific to document data sources unless the
  documentation for another data source explicitly states that it supports
  them.
</Callout>
