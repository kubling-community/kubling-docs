...
![Forward operations and reverse compensation operations after an error](../../../../public/img/op_rollback.svg)
...
See [Transactions](/engine/tx/intro) for Kubling's transaction model.
