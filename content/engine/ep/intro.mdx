...
Template endpoint logic is defined using `YAML` files, parsed by the [template engine](/template/parser), and registered in the engine endpoint list during initialization.
