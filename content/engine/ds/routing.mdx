...
![Routing data source selecting between equivalent database data sources](../../../public/img/routing_ds.svg)
...
![Equivalent tables imported by a routing data source from two database data sources](../../../public/img/routing_ds_tables.svg)
