...
The Kubling [native protocol](/concepts/architecture#transport) is based on Red Hat's Teiid project, which is why you still see "teiid" in the connection string.
...
#
# This property is required only if performing mTLS authentication that requires a specific private key.
#

org.teiid.ssl.keyStore=/sample/path/client.p12

#
# The key store password
#

org.teiid.ssl.keyStorePassword=mypass
...
org.teiid.ssl.trustStore=/sample/path/client-truststore.ks
