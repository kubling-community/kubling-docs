...
![Kubling artifact loading sequence from application configuration to function bundles](../../public/img/init-file-resolution-sequence.svg)
...
![Dependencies among Kubling configuration and module artifacts](../../public/img/artifacts-dep.svg)
