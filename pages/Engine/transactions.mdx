...
This challenge is further amplified when a Data Source is implemented programmatically, such as with [Script Document Data Sources](/Engine/data-sources#script-document-data-source-script_document_js).
...
|:--------------------------------------------------------------------------------------------|:---------------------:|
| [`EMBEDDED_INMEM`](/Engine/data-sources#embedded-inmemory-data-source-embedded_inmem)       |           ✔️           |
| [`POSTGRESQL`](/Engine/data-sources#postgresql-data-source-postgresql)                      |           ✔️           |
| [`MYSQL`](/Engine/data-sources#mysql-data-source-mysql)                                     |           ✔️           |
| [`KUBERNETES`](/Engine/data-sources#kubernetes-data-source-kubernetes)                      |           ❌           |
| [`SCRIPT_DOCUMENT_JS`](/Engine/data-sources#script-document-data-source-script_document_js) |           ❌           |
