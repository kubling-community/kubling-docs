...
A Kubling instance can serve as a data source for another Kubling instance, facilitating the creation of a decentralized data mesh.

This data source falls under the **database data source** category, meaning it supports features like **passthrough mode** and **additional column configuration**, 
similar to other [database sources](/Engine/ds/db-data-sources).
