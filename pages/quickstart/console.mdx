...
<Callout type="warning">
  It is important to note that, in production environments, it is not recommended to enable console, since Kubling is designed with instance immutability in mind.
</Callout>
