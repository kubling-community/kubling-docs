...
It is important to note that the only local file needed by the engine is the application configuration, since the rest of the artifacts can be fetched from remote origins.
