...
## Support all DDL options in non-document data sources <Tag bgColor={"bg-kubling-green"} txtColor={"text-white"} description={"Analysis"} txtFont={"font-gilroyBold"} /> <Tag bgColor={"bg-kubling-dark-violet"} txtColor={"text-white"} description={"High Prio"} txtFont={"font-gilroyBold"} />
...
## Support Couchbase Data Source <Tag bgColor={"bg-kubling-green"} txtColor={"text-white"} description={"Implemented"} txtFont={"font-gilroyBold"} />
We will support Couchbase, possibly with some limitations, in the next release.

## Support Cassandra Data Source <Tag bgColor={"bg-kubling-green"} txtColor={"text-white"} description={"Implemented"} txtFont={"font-gilroyBold"} />
...
## Cache <Tag bgColor={"bg-kubling-green"} txtColor={"text-white"} description={"Implemented"} txtFont={"font-gilroyBold"} /> <Tag bgColor={"bg-kubling-dark-violet"} txtColor={"text-white"} description={"High Prio"} txtFont={"font-gilroyBold"} />
