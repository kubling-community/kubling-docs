...
Kubling Data Source Adapters are divided into five major types:
...
- **Proxy Data Source:**<br/>
This is the only adapter not backed by a remote data origin. Instead, it functions as a layer on top of other Kubling local data sources, 
enabling enrichment, composition, and other advanced features.
