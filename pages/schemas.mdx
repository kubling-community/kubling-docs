...
```yaml
type: "object"
id: "schema:kubling:config:app:Application"
properties:
  transports:
    type: "object"
    id: "schema:kubling:config:app:Transports"
    properties:
      pgProtocol:
        type: "object"
        id: "schema:kubling:config:app:Transport"
        properties:
          bindAddress:
            type: "string"
          ...
          sslConfig:
            type: "object"
            id: "schema:kubling:config:app:SSLConfig"
            properties:
              storeType:
                type: "string"
      ...
      nativeProtocol:
        type: "object"
        $ref: "schema:kubling:config:app:Transport"
  management:
    type: "object"
    id: "schema:kubling:config:app:Management"
    properties:
      enableRestartEndpoint:
        type: "boolean"
  vdb:
    type: "object"
    id: "schema:kubling:config:app:VirtualDatabase"
    properties:
      descriptorBundle:
        type: "string"
  console:
    type: "object"
    id: "schema:kubling:config:app:Console"
    properties:
      moduleRepoBaseURI:
        type: "string"
...
```yaml
type: "object"
id: "schema:kubling:model:vdb:BundleInfo"
properties:
  virtualDatabases:
    type: "array"
  ...
  authentication:
    type: "object"
    id: "schema:kubling:model:vdb:Authentication"
    properties:
      scriptFilePath:
        type: "string"
      ...
      module:
        type: "object"
        id: "schema:kubling:translation:scripting:base:model:Module"
        properties:
          zipFilePath:
            type: "string"
  ...
  actionTemplatesFunctionModule:
    type: "object"
    $ref: "schema:kubling:translation:scripting:base:model:Module"
  sqlFunctionModule:
    type: "object"
    $ref: "schema:kubling:translation:scripting:base:model:Module"
```
...
```yaml
type: "object"
id: "schema:kubling:model:vdb:VirtualDatabase"
properties:
  name:
    type: "string"
  ...
  dataSources:
    ...
    items:
      type: "object"
      id: "schema:kubling:model:vdb:DataSource"
      properties:
        name:
          type: "string"
        ...
        schema:
          type: "object"
          id: "schema:kubling:model:vdb:DataSourceSchema"
  ...
  aggregatorSchemaModels:
    ...
    items:
      type: "object"
      id: "schema:kubling:model:vdb:AggregatorSchemaModel"
      properties:
        name:
          type: "string"
        ...
        tables:
          ...
          items:
            type: "object"
            id: "schema:kubling:model:vdb:AggregatorSchemaTable"
            properties:
              name:
                type: "string"
  ...
  rbacDataRoles:
    ...
    items:
      type: "object"
      id: "schema:kubling:model:vdb:rbac:RBACDataRole"
      properties:
        name:
          type: "string"
        ...
        permissions:
          ...
          items:
            type: "object"
            id: "schema:kubling:model:vdb:rbac:RBACPermission"
            properties:
              resource:
                type: "string"
...
rbacDataRoles:
  - name: "full_control"
    ...
    roleNameMappings:
      - "ROLE_FULL"
    permissions:
      - resource: "k8s_1.DEPLOYMENT"
        resourceType: TABLE
        allowCreate: true
        allowRead: true
        allowUpdate: true
        allowDelete: true
      - resource: "k8s_2.DEPLOYMENT"
        resourceType: TABLE
        allowCreate: true
        allowRead: true
        allowUpdate: true
...
```yaml
type: "object"
id: "schema:kubling:translation:scripting:base:model:ScriptingBundleInfo"
properties:
  initScript:
    type: "object"
    id: "schema:kubling:translation:scripting:base:model:ScriptMetadata"
    properties:
      submodule:
        type: "string"
      ...
      scriptFilePath:
        type: "string"
        description: "Path to the script, relative to this bundle info location inside\
          \ the module."
  resultSetScript:
    type: "object"
    $ref: "schema:kubling:translation:scripting:base:model:ScriptMetadata"
  insertScript:
    type: "object"
    $ref: "schema:kubling:translation:scripting:base:model:ScriptMetadata"
  updateScript:
  ...
  scheduledScripts:
    ...
    items:
      type: "object"
      id: "schema:kubling:translation:scripting:base:model:ScheduledScript"
      properties:
        cron:
          type: "string"
  ...
  contextVariables:
    ...
    items:
      type: "object"
      id: "schema:kubling:translation:scripting:base:model:BundleContextVariable"
      properties:
        name:
          type: "string"
        sensitive:
  ...
  innerDDLFilePath:
    type: "string"
    description: "Path to the DDL file, relative to this bundle info location inside\
      \ the module."
  innerTranslatorConfigFilePath:
    type: "string"
    description: "Path to the translator configuration file, relative to this bundle\
      \ info location inside the module."
```
...
```yaml
type: "object"
id: "schema:kubling:model:sql:function:SQLFunctionBundleInfo"
properties:
  partitions:
    type: "integer"
  ...
  functions:
    ...
    items:
      type: "object"
      id: "schema:kubling:model:sql:function:SQLFunctionDefinition"
      properties:
        name:
          type: "string"
        ...
        scriptFilePath:
          type: "string"
          description: "Path to the function script, relative to this bundle info\
            \ location inside the module."
```
...
functions:
  - name: "az_sql_get_rg"
    scriptFilePath: "fn/azure/sql_get_rg.js"
```

## Template Function Module bundle information file (`bundle-function-info.yaml`)
```yaml
type: "object"
id: "schema:kubling:model:template:function:TemplateFunctionDefinition"
properties:
  name:
    type: "string"
    description: "Function name."
  ...
  scriptFilePath:
    type: "string"
    description: "Path to the function script, relative to this bundle info location\
      \ inside the module."
  partitions:
    type: "integer"
    description: "Internal Script contexts pool partitions. Default: 2"
...
```yaml
type: "object"
id: "schema:kubling:model:vdb:sources:BaseDatabaseSourceConfig"
properties:
  dataSourceName:
    type: "string"
...
```yaml
type: "object"
id: "schema:kubling:model:vdb:sources:script:ScriptingSourceConfig"
properties:
  contextVariables:
    type: "object"
